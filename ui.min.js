...
*/
        ...
        var pref = rcmail.get_cookie('colorMode'),
            ...
            switch_color_mode = function() {
                if (color_mode == 'dark') {
					...
					$('.sebicon_contrast_txt').text(rcmail.gettext('Mode clar'));
					...
					$('.sebicon_contrast_txt').text(rcmail.gettext('Mode fosc'));
	...
	function bootstrap_style_elastic2022(context)
	{
...
*/
    ...
    function rcmail_popup_init(o)
    {
		...
		bootstrap_style_elastic2022(o.obj);
...
*/
    ...
    function dialog_open(dialog)
    {
		...
		bootstrap_style_elastic2022(dialog.uiDialog);
    };
...
if(!document.querySelector("#menuleft"))
    {
	var HTMLmenu="<div id='menuleft'><div>&nbsp;</div><div id='menuleft_cont'></div><roundcube:object name='logo' src='/images/nuvol_h.svg' id='logo' alt='Logo' style='margin-top: 1.5rem;' /><div id='menuleft_bottom' class='menu'></div></div>"
